...
#        self.settingsGrid = QGridLayout()
    ...
    def initFileBar(self):
        ...
        self.openSubButton = QAction('Open', self)
        ...
        self.phraseButton.setShortcut('Ctrl+P')
        ...
        self.countButton.setShortcut('Ctrl+W')        
        ...
        self.varietyButton.setShortcut('Ctrl+U')
...
#        self.toolsMenu.addAction(self.settingsButton)
    ...
    def initList(self):
        ...
        self.listTabs.setFixedSize(355, 521)
        self.listTabs.move(15, 70)
    ...
    def setGraph(self, filename, info):
        ...
        self.graph = QPixmap(filename)
        self.graph.scaledToWidth(650)
